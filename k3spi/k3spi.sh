...
master1=192.168.0.181
master2=192.168.0.182
worker1=192.168.0.183
worker2=192.168.0.184
worker3=192.168.0.185
worker4=192.168.0.186
worker5=192.168.0.187
...
# Array of all
all=($master1 $master2 $worker1 $worker2 $worker3 $worker4 $worker5)

# Array of all minus master
allnomaster1=($master2 $worker1 $worker2 $worker3 $worker4 $worker5)

#Loadbalancer IP range
lbrange=192.168.0.71-192.168.0.80
